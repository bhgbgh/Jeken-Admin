<template>
  <header class="main-header animated" :class="{closeLogo:sidebar.collapsed,mobileLogo:device.isMobile}">
    <a href="#" class="logo">
      <span class="logo-lg"><i class="fa fa-tags"></i>&nbsp; <b>Jeken-Admin</b></span>
    </a>
    <nav class="navbar">
      ...
      <div class="navbar-custom-menu">
        ...
        <el-dropdown class="navbar-dropdown" trigger="click">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item v-for="(item,index) in list" :key="item.id">
        ...
        <el-dropdown class="navbar-dropdown" trigger="click">
          <div class="el-dropdown-link">
            <!-- <img v-if="userInfo.avatar" :src='userInfo.avatar' style="width: 25px;height: 25px;border-radius: 50%; vertical-align: middle;" alt="U"> -->
          ...
          <el-dropdown-menu slot="dropdown" style="padding: 0px">
            <div>
              <!-- <div class="header-pic"> -->
                <!-- <img v-if="userInfo.avatar" :src='userInfo.avatar' class="img-circle" alt="User Image" > -->
                <!-- <em class="fa fa-user"></em>
                <p>{{userInfo.name}}</p>
              </div> -->
              <div class="pull-left">
...
<style scoped>
  ...
  .navbar-custom-menu .el-dropdown-link em{
    font-size: 20px;
  }
